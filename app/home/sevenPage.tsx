...
export default function SevenPage() {
  ...
  // 3-Second Automatic Slider Effect for Study Destinations
  useEffect(() => {
    if (isPaused) return;
  ...
  return (
    <div className="w-full bg-white text-gray-900 font-sans selection:bg-[#f7a600] selection:text-[#3b2768]">
        ...
        <div className="max-w-7xl mx-auto space-y-10">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center pt-4">
            ...
            <div className="lg:col-span-6 space-y-3">
              ...
              <div className="pt-2">
                <a href="#" className="text-[#f7a600] font-bold text-sm hover:underline inline-block">
                  Read More
                </a>
              </div>
            </div>
      ...
      {/* ================= 5. STUDY ABROAD EXPO BANNER SECTION ================= */}

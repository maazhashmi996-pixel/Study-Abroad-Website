      ...
      <div className="max-w-7xl mx-auto px-3 lg:px-20">
        ...
        <div className="grid lg:grid-cols-2 gap-3 items-center">
          ...
          <div>
            ...
            <h1 className="text-[#43246f] font-bold leading-tight text-3xl md:text-5xl">
            ...
            <button className="mt-3 bg-[#F5A623] hover:bg-[#E69512] transition-all duration-300 text-white px-10 py-4 rounded-full font-semibold">
              Get Started
            </button>

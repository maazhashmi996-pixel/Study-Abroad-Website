        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-6">
            ...
            <h1 className="text-3xl font-black tracking-tight text-white sm:text-5xl lg:text-6xl">
              Sialkot Study Abroad <span className="text-[#0b5cff]">Expo 2026</span>
            </h1>
            ...
            <div className="relative mt-4 aspect-[21/9] w-full overflow-hidden rounded-3xl border border-slate-800 bg-slate-800 shadow-2xl">
              <Image
                src="/images/events/sialkot.jpg" // Replace with your image path
                alt="Sialkot Study Abroad Expo 2026"
                fill
                priority
          ...
          <div className="space-y-10 lg:col-span-7 xl:col-span-8">
              ...
              <div className="group rounded-2xl border border-slate-800 bg-slate-800/50 p-4 transition-colors hover:border-red-500/50">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs font-black text-white sm:text-sm">Hotel One, Sialkot</p>
                  </div>
                </div>
              </div>
            ...
            <div className="space-y-4">
              ...
              <p className="text-sm leading-relaxed text-slate-300 sm:text-base">
                Get a chance to join the most in-demand educational expo in all of Sialkot. Unlock unprecedented opportunities to study in top global destinations including the UK, USA, Australia, Canada, Europe, and Asia.
              </p>

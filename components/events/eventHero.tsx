...
export default function StudyPage() {
  ...
  return (
    <div className="w-full bg-white text-gray-900 font-sans">
      ...
      {/* ================= 3. STUDY ABROAD EXPO BANNER SECTION ================= */}
        ...
        <div className="max-w-7xl mx-auto space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4 items-stretch">
            <div className="bg-[#f7a600] rounded-2xl p-6 flex flex-col justify-between shadow-sm min-h-[260px]">
              <h3 className="text-[#3b2768] font-bold text-2xl leading-tight">
                Meet <br /> 500+ <br /> Universities
              </h3>
              <div className="mt-4 bg-white/20 rounded-xl p-2 text-center text-3xl">🏛️</div>
            </div>

            <div className="bg-[#3b2768] text-white rounded-2xl p-6 flex flex-col justify-between shadow-sm min-h-[260px]">
              <h3 className="text-[#f7a600] font-bold text-2xl leading-tight">
                Your Dream <br /> City Awaits
              </h3>
              <div className="mt-4 bg-white/10 rounded-xl p-2 text-center text-3xl">🏙️</div>
            </div>
            ...
            <div className="bg-gradient-to-br from-[#3b2768] via-[#523d7f] to-[#f7a600] text-white rounded-2xl p-6 flex flex-col justify-center items-center text-center shadow-sm min-h-[260px]">
              <span className="text-xs tracking-widest uppercase font-semibold text-[#f7a600]">
                Study Abroad
              </span>
              <h3 className="font-extrabold text-5xl tracking-wider my-2">EXPO</h3>
            </div>
            ...
            <div className="bg-[#f7a600] rounded-2xl p-6 flex flex-col justify-between shadow-sm min-h-[260px]">
              ...
              <div className="mt-4 bg-white/20 rounded-xl p-2 text-center text-3xl">🎓</div>
            </div>
          ...
          <div className="flex justify-center pt-4">
            <button className="bg-[#f7a600] hover:bg-amber-500 text-[#3b2768] font-bold px-10 py-3 rounded-full text-base transition-transform active:scale-95 shadow-md">
              Register Now
            </button>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-center">
            <div className="lg:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-5">
              {journeyCards.map((item, index) => (
                ...
                >
                  <div className="text-[#44246f]">{item.icon}</div>

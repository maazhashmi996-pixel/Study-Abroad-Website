...
export default function First() {
  return (
    <section className="w-full bg-black py-6 sm:py-10 px-4 sm:px-6 lg:px-8 border-b border-slate-900">
      <div className="max-w-7xl mx-auto overflow-hidden rounded-xl sm:rounded-2xl shadow-2xl border border-slate-800 bg-slate-900 p-2 sm:p-3 relative">
        ...
        <div className="relative w-full aspect-[16/9] sm:aspect-[21/9] rounded-xl overflow-hidden">
          <Image
            src="/images/services/istudy.jpg"
            alt="Study Abroad"
            fill
            priority

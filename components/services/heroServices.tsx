...
export default function VisaHero() {
  return (
    <section className=" text-slate-900 py-12 sm:py-16 lg:py-20 border-b border-slate-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-8 lg:gap-14">
          ...
          <div className="text-center lg:text-left">
            ...
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black leading-tight sm:leading-tight lg:leading-tight text-slate-900 tracking-tight">
            ...
            <p className="mt-4 sm:mt-6 lg:mt-8 text-sm sm:text-base lg:text-lg leading-relaxed text-slate-700 max-w-2xl mx-auto lg:mx-0">
          ...
          <div className="flex justify-center lg:justify-end w-full">
            <div className="relative w-full max-w-md lg:max-w-xl aspect-square rounded-2xl overflow-hidden border border-slate-900 bg-slate-900/90 shadow-2xl p-4">
              <Image

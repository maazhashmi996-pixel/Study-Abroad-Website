      ...
      <div className=" inset-0 flex items-end pb-2 sm:pb-6 md:pb-8 px-3 sm:px-88 md:px-10 z-20">
        <div className="absolute max-w-7xl mx-auto w-full">
          <ul className="relative list-disc text-xs b-0.5 l-6 pl-12 sm:ml-6 underline  sm:space-y-3 text-white sm:text-base md:text-xs lg:text-xl drop-shadow-md">
            ...
            <li>CAD 15,000 – 25,000 Annual Tuition Fee</li>
            <li>Up to 3 Years Post Study Work Visa</li>
          </ul>
        </div>
      </div>
         </section>
...
From globally ranked universities to affordable tuition and a clear path to permanent residency, Canada offers one of the most attractive education systems in the world. Thousands of International and Pakistani students choose Canada each year for its quality academics, flexible work options, and safe, inclusive environment.</p>

        {/* Paragraph 2 */}
        <p className="text-sm sm:text-base md:text-lg leading-relaxed text-slate-600  font-semibold">
Whether you’re planning for an undergraduate degree, master’s program, or a diploma from a reputed Canadian institution, below, you’ll find all the essential information you need from admission and visa requirements to scholarships and post-study work opportunities. </p>
</div>
    </section>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 text-center md:text-left">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight">
            Why Study in <span className="text-[#0b5cff]">Canada?</span>
          </h2>
        </div>

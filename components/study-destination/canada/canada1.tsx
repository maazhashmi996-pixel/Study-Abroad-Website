...
export default function Canada1() {
     const tableOfContents = [
    { title: "Admission requirements in Canada", id: "admission-requirements" },
    { title: "Cost of studying in Canada", id: "cost-of-studying" },
    { title: "Scholarships for students in Canada", id: "scholarships" },
    { title: "Visa requirements in Canada", id: "visa-requirements" },
    { title: "Popular courses to Study in Canada", id: "popular-courses" },
    { title: "Post-Study work opportunities", id: "post-study-work" },
    { title: "Cost of living in Canada", id: "cost-of-living" },
  ...
  return (
    <div>
      ...
      <div className="relative w-full h-[320px] sm:h-[400px] md:h-[480px] lg:h-[550px]">
        <Image
          src="/images/study-dest/canada.jpg"
          alt="learn"
          fill
          priority
...
Experience world-class education in one of the happiest and safest nations on earth. Consistently ranked at the top of the UN’s World Happiness Report since 2012, Canada offers an innovative, secure, and welcoming environment for international students.        </p>

        {/* Paragraph 2 */}
        <p className="text-sm sm:text-base md:text-lg leading-relaxed text-slate-600  font-semibold">
Studying in Canada isn't just about gaining a globally recognized degree—it's about building a strong foundation for your international career while enjoying top-tier healthcare, high living standards, and unparalleled quality of life.        </p>

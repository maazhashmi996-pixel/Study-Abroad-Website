...
export default function lithounia1() {
     const tableOfContents = [
    { title: "Admission requirements in Lithounia", id: "admission-requirements" },
    { title: "Cost of studying in Lithounia", id: "cost-of-studying" },
    { title: "Scholarships for students in Lithounia", id: "scholarships" },
    { title: "Visa requirements in Lithounia", id: "visa-requirements" },
    { title: "Popular courses to Study in Lithounia", id: "popular-courses" },
    { title: "Post-Study work opportunities", id: "post-study-work" },
    { title: "Cost of living in Lithounia", id: "cost-of-living" },
...
Experience world-class education in one of the happiest and safest nations on earth. Consistently ranked at the top of the UN’s World Happiness Report since 2012, Lithounia offers an innovative, secure, and welcoming environment for international students.        </p>

        {/* Paragraph 2 */}
        <p className="text-sm sm:text-base md:text-lg leading-relaxed text-slate-600  font-semibold">
Studying in Lithounia isn't just about gaining a globally recognized degree—it's about building a strong foundation for your international career while enjoying top-tier healthcare, high living standards, and unparalleled quality of life.        </p>

  ...
  const requirements = [
   ...
   const dropdownOptions = {
    ...
    countries: [
      ...
      "United State of America ", "Ireland", "Italy", "Malaysia", "Malta", "Netherlands",
               ...
               <div>
                 ...
                 <div className="flex items-center gap-3 mb-6">
                   ...
                   <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
                     Cost of Studying in <span className="text-[#0b5cff]">United State of America </span>
                   </h2>
                 </div>
                 ...
                 <div className="mb-8">
                   ...
                   <p className="text-sm text-slate-600 mb-4">
                     United State of America  remains one of the most budget-friendly EU countries for international students.
                   </p>
                   <ul className="space-y-2 bg-slate-50 border border-slate-200/60 rounded-xl p-4 text-sm text-slate-700 font-medium">
                     <li className="flex justify-between items-center border-b border-slate-200/50 pb-2">
                       ...
                       <span className="font-bold text-slate-900"> $25,000 to $55,000 / year</span>
                     </li>
                     <li className="flex justify-between items-center border-b border-slate-200/50 py-2">
                       <span>Master’s Programs</span>
                       <span className="font-bold text-slate-900"> $22,000 to $50,000 /annually</span>
                     </li>
                 ...
                 <div>
                   ...
                   <p className="text-sm text-slate-600 mb-4">
                     Living in United State of America  is affordable by European standards, especially outside Budapest.
                   </p>
             ...
             <div className="space-y-8 flex flex-col justify-between">
               ...
               <div className="bg-white border border-slate-200/80 rounded-2xl p-6 sm:p-8 shadow-sm border-l-4 border-l-red-500">
                 <div className="flex items-center gap-3 mb-4">
                   ...
                   <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
                     Study Intakes in <span className="text-red-500">United State of America </span>
                   </h2>
                 </div>
                 <p className="text-sm text-slate-600 mb-4">
               ...
               <div className="bg-white border border-slate-200/80 rounded-2xl p-6 sm:p-8 shadow-sm border-l-4 border-l-slate-700 flex-1 flex flex-col justify-between">
                 <div>
                   ...
                   <p className="text-sm text-slate-600 mb-4">
                     United State of America  offers well-known scholarship opportunities for international students:
                   </p>
                   <ul className="space-y-2.5 text-xs sm:text-sm text-slate-700 mb-4">
                     <li className="flex items-start gap-2.5 p-2.5 bg-slate-50 border border-slate-200/50 rounded-lg">
                       ...
                       <span>However, outstanding overseas students can apply for merit-based scholarships given by several US colleges. Therefore, these scholarships come in different amounts and might pay for all or only a portion of the tuition and expenses. Look for scholarship opportunities on the websites of the colleges you have chosen.</span>
                     </li>
                     <li className="flex items-start gap-2.5 p-2.5 bg-slate-50 border border-slate-200/50 rounded-lg">
                       <span className="w-2 h-2 rounded-full bg-[#0b5cff] mt-1.5 shrink-0" />
                       <span><strong>It provides funding by the US Department of State, this prestigious program offers grants for international graduate students to study and conduct research at US universities.</strong></span>
                     </li>
                     <li className="flex items-start gap-2.5 p-2.5 bg-slate-50 border border-slate-200/50 rounded-lg">
                       <span className="w-2 h-2 rounded-full bg-slate-700 mt-1.5 shrink-0" />
                       <span><strong>It provides need-based scholarships for international students pursuing postgraduate studies at their US campus.</strong></span>
                     </li>
                   </ul>
                 </div>

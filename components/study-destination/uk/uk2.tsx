...
export default function UK2() {
  ...
  const requirements = [
   ...
   const dropdownOptions = {
    ...
    countries: [
      "Australia", "Canada", "United Kingdom", "Finland", "France", "Germany",
      "United Kingdom ", "Ireland", "Italy", "Malaysia", "Malta", "Netherlands",
    ...
    <section className="bg-white px-4 sm:px-8 md:px-12 lg:px-20 py-12 md:py-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 md:mb-14 text-center md:text-left">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#1a233d] tracking-tight mb-4">
            Admission Requirements <span className="text-[#0b5cff]">In United Kingdom</span>
          </h2>
          <p className="text-slate-500 text-sm md:text-base max-w-2xl leading-relaxed">
            United Kingdom maintains high academic standards. To ensure a successful application, students must meet specific educational backgrounds and performance metrics.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 md:mb-12 text-center md:text-left">
          ...
          <p className="text-slate-500 text-sm md:text-base max-w-2xl leading-relaxed">
            Ensure you have all the necessary documentation ready before starting your admission process for United Kingdom.
          </p>
        </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
                    Cost of Studying in <span className="text-[#0b5cff]">United Kingdom </span>
                  </h2>
                </div>
                ...
                <div className="mb-8">
                  ...
                  <p className="text-sm text-slate-600 mb-4">
                    United Kingdom  remains one of the most budget-friendly EU countries for international students.
                  </p>
                  <ul className="space-y-2 bg-slate-50 border border-slate-200/60 rounded-xl p-4 text-sm text-slate-700 font-medium">
                    <li className="flex justify-between items-center border-b border-slate-200/50 pb-2">
                      ...
                      <span className="font-bold text-slate-900"> £10,000 and £24,000 / year</span>
                    </li>
                    <li className="flex justify-between items-center border-b border-slate-200/50 py-2">
                      <span>Master’s Programs</span>
                      <span className="font-bold text-slate-900"> £12,000 and £28,000  / year</span>
                    </li>
                    <li className="flex justify-between items-center pt-2">
                      <span>Medical & Dentistry Programs</span>
                      <span className="font-bold text-slate-900">£15,000 to £24,000  / year</span>
                    </li>
                  </ul>
                ...
                <div>
                  ...
                  <p className="text-sm text-slate-600 mb-4">
                    Living in United Kingdom  is affordable by European standards, especially outside Budapest.
                  </p>
            ...
            <div className="space-y-8 flex flex-col justify-between">
              ...
              <div className="bg-white border border-slate-200/80 rounded-2xl p-6 sm:p-8 shadow-sm border-l-4 border-l-red-500">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
                    Study Intakes in <span className="text-red-500">United Kingdom </span>
                  </h2>
                </div>
                <p className="text-sm text-slate-600 mb-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                  ...
                  <div className="p-3.5 bg-slate-50 border border-slate-200/60 rounded-xl">
                    ...
                    <p className="text-sm font-bold text-slate-900 mt-1">From September until December</p>
              ...
              <div className="bg-white border border-slate-200/80 rounded-2xl p-6 sm:p-8 shadow-sm border-l-4 border-l-slate-700 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-sm text-slate-600 mb-4">
                    United Kingdom  offers well-known scholarship opportunities for international students:
                  </p>
                  <ul className="space-y-2.5 text-xs sm:text-sm text-slate-700 mb-4">
                    ...
                    <li className="flex items-start gap-2.5 p-2.5 bg-slate-50 border border-slate-200/50 rounded-lg">
                      ...
                      <span><strong>Above all, international students can apply for merit-based undergraduate and graduate scholarships from several UK universities. While, these scholarships come in different amounts and might pay for all or only a portion of the tuition. Make sure to look at the scholarships available on the school websites you selected. Moreover, book a meeting session with us where we assist both undergraduate and graduate students seeking scholarships to study in the UK.</strong></span>
                    </li>
                  </ul>
                </div>
                <p className="text-xs text-slate-600 bg-slate-50 p-3 rounded-xl border border-slate-200/60">
Moreover, with the help of our online resources and our extensive relationships with UK universities, all qualified applicants can choose the scholarship that will most benefit their future.                </p>
              </div>

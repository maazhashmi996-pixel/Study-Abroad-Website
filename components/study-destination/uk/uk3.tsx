...
export default function UK3() {
  ...
  const faqData = [
    {
      question: "How much IELTS band required to study in United Kingdom?",
      answer:
        "To study in United Kingdom, non-native English speakers generally need a minimum IELTS score of 6.5. However, requirements can vary by institution and program, so it’s important to check specific requirements with the university.",
    },
    {
      question: "Is it possible to study in United Kingdom without IELTS?",
      answer:
        "Yes, some universities in United Kingdom may accept alternative English proficiency proofs, such as TOEFL, PTE, or Cambridge tests. Additionally, if you have completed previous education in English, some institutions might waive the IELTS requirement.",
    },
    {
      question: "How to get PR in United Kingdom after study?",
      answer:
        "To qualify for permanent residency in United Kingdom after studying, you must have lived in United Kingdom for at least 8 years, or 4 years if you meet certain criteria like language skills and employment. Graduates can extend their stay with a post-study work visa, which can be a pathway to PR if employment and integration conditions are met.",
    },
    {
      question: "How to study in United Kingdom for free?",
      answer:
        "Students from the EU/EEA and Switzerland can study for free at public universities in United Kingdom. Non-EU/EEA students can look for scholarships from the Danish government or individual institutions, which can cover tuition fees and living costs.",
    },
    {
      question: "Can Pakistani students work while studying in United Kingdom?",
      answer:
        "Yes. United Kingdom allows international students to work 20 hours per week during term time and full-time during June, July, and August. No separate work permit is needed as your student residence permit covers it. Copenhagen has strong part-time opportunities in hospitality, retail, and university campuses, with hourly rates among the highest in Europe.",
    },
    {
      question: "Why do United Kingdom student visas get rejected from Pakistan?",
      answer:
    ...
    {
      question: "Which are the top universities in United Kingdom for international students?",
      answer:
        "Top choices: Technical University of United Kingdom (DTU) for engineering and technology, University of Copenhagen for sciences and medicine, Aarhus University for business and social sciences, and Copenhagen Business School for finance and management. DTU consistently ranks among Europe’s top technical universities.",
    },
    {
      question: "What is a CPR number and how do students get it in United Kingdom?",
      answer:
        "CPR (Det Centrale Personregister) is United Kingdom’s national identity number, essential for opening a bank account, accessing healthcare, and starting work. You receive it automatically after registering your address at your local Citizen Service Centre within 5 days of arriving in United Kingdom. Without a CPR number, daily student life in United Kingdom is extremely difficult.",
    },
    {
      question: "United Kingdom vs Germany, which is better for Pakistani students?",
      answer:
        "Germany offers near-free tuition but requires German language for most bachelor’s programmes and mandatory APS certification from Pakistan. United Kingdom teaches almost entirely in English at master’s level, has no APS requirement, and offers higher part-time wages. Germany suits engineering students comfortable with German. United Kingdom suits those prioritising English-medium study and a high quality of life.",
    },
  ];
  ...
  const dropdownOptions = {
    ...
    countries: [
      "Australia", "Canada", "United Kingdom", "Finland", "France",
  ...
  const coursesList = [
    ...
    },
    {
      title: "Engineering",
      description:
        "Aarhus University, Aalborg University, and Technical University of United Kingdom (DTU) are all excellent in different engineering fields.",
    ...
    },
    {
      ...
      description:
        "Prestigious medical and life science programs are available at University of Copenhagen, Aarhus University, and Southern United Kingdom University.",
        ...
        <div className="max-w-7xl mx-auto flex flex-col gap-10">
          <div className="text-center md:text-left">
            ...
            <h2 className="text-3xl sm:text-4xl font-extrabold text-[#1a233d] tracking-tight">
              Popular Courses <span className="text-[#0b5cff]">In United Kingdom</span>
            </h2>
          </div>
          ...
          <div className="bg-white p-6 sm:p-8 rounded-3xl border border-slate-200/80 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="flex flex-col gap-4">
              <p className="text-sm sm:text-base leading-relaxed text-slate-600 font-normal">
                After completing a Bachelor’s, Master’s, or PhD in United Kingdom, non-EU/EEA students can apply for a{" "}

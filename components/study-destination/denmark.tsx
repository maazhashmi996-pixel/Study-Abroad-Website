export default function Denmark() {
  return (
    <section className="px-4 sm:px-8 md:px-12 lg:px-20 py-8 md:py-12 bg-white text-[#43246f]">
      <div className="max-w-7xl mx-auto flex flex-col gap-4 sm:gap-6">
        
        {/* Heading */}
        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold border-b-2 border-[#43246f]/10 pb-2">
          Denmark
        </h1>

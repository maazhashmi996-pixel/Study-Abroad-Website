...
export default function Turkey2() {
  ...
  const requirements = [
   ...
   const dropdownOptions = {
    ...
    countries: [
      "Australia", "Canada", "Turkey", "Finland", "France", "Germany",
      "Turkey", "Ireland", "Italy", "Malaysia", "Malta", "Netherlands",
    ...
    <section className="bg-white px-4 sm:px-8 md:px-12 lg:px-20 py-12 md:py-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 md:mb-14 text-center md:text-left">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#1a233d] tracking-tight mb-4">
            Admission Requirements <span className="text-[#0b5cff]">In Turkey</span>
          </h2>
          <p className="text-slate-500 text-sm md:text-base max-w-2xl leading-relaxed">
            Turkey maintains high academic standards. To ensure a successful application, students must meet specific educational backgrounds and performance metrics.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 md:mb-12 text-center md:text-left">
          ...
          <p className="text-slate-500 text-sm md:text-base max-w-2xl leading-relaxed">
            Ensure you have all the necessary documentation ready before starting your admission process for Turkey.
          </p>
        </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
                      Cost of Studying in <span className="text-[#0b5cff]">Turkey</span>
                    </h2>
                  </div>
                  ...
                  <div className="mb-8">
                    ...
                    <p className="text-sm text-slate-600 mb-4">
                      Turkey remains one of the most budget-friendly EU countries for international students.
                    </p>
                    <ul className="space-y-2 bg-slate-50 border border-slate-200/60 rounded-xl p-4 text-sm text-slate-700 font-medium">
                      <li className="flex justify-between items-center border-b border-slate-200/50 pb-2">
                        ...
                        <span className="font-bold text-slate-900">€ $20,000  / year</span>
                      </li>
                      <li className="flex justify-between items-center border-b border-slate-200/50 py-2">
                        <span>Public Institute</span>
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-600 mb-4">
                      Living in Turkey is affordable by European standards, especially outside Budapest.
                    </p>
              ...
              <div className="space-y-8 flex flex-col justify-between">
                ...
                <div className="bg-white border border-slate-200/80 rounded-2xl p-6 sm:p-8 shadow-sm border-l-4 border-l-red-500">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
                      Study Intakes in <span className="text-red-500">Turkey</span>
                    </h2>
                  </div>
                  <p className="text-sm text-slate-600 mb-4">
                    Turkish universities usually offer two main intakes:
                  </p>
                ...
                <div className="bg-white border border-slate-200/80 rounded-2xl p-6 sm:p-8 shadow-sm border-l-4 border-l-slate-700 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <p className="text-sm text-slate-600 mb-4">
                     However, international students can apply for scholarships given by several Turkish colleges. These scholarships come in different amounts and might pay for all or only a portion of the tuition. Look through the scholarship options on the websites of the institutions you have chosen. Here are few examples:
                    </p>
                    <ul className="space-y-2.5 text-xs sm:text-sm text-slate-700 mb-4">
                      <li className="flex items-start gap-2.5 p-2.5 bg-slate-50 border border-slate-200/50 rounded-lg">
                        ...
                        <span>Koç University Scholarships: This prestigious university provides merit-based scholarships for international students at the Master’s and PhD levels.</span>
                      </li>
                      <li className="flex items-start gap-2.5 p-2.5 bg-slate-50 border border-slate-200/50 rounded-lg">
                        <span className="w-2 h-2 rounded-full bg-[#0b5cff] mt-1.5 shrink-0" />
                        <span><strong>Bilkent University Scholarships: Bilkent University offers various scholarships for international students, including partial and full tuition waivers.</strong></span>
                      </li>
                    
                    </ul>
                  </div>
                  <p className="text-xs text-slate-600 bg-slate-50 p-3 rounded-xl border border-slate-200/60">
                    Scholarships are competitive. <strong>Stipendium Turkish</strong> can cover tuition fees, accommodation support, and a monthly stipend, making it a strong option for eligible students.
                  </p>
                </div>

...
export default function France1() {
    ...
    { title: "Admission requirements in France", id: "admission-requirements" },
    { title: "Cost of studying in France", id: "cost-of-studying" },
    { title: "Scholarships for students in France", id: "scholarships" },
    { title: "Visa requirements in France", id: "visa-requirements" },
    { title: "Popular courses to Study in France", id: "popular-courses" },
    { title: "Post-Study work opportunities", id: "post-study-work" },
    { title: "Cost of living in France", id: "cost-of-living" },
  ...
  return (
    <div>
      ...
      <div className="relative w-full h-[320px] sm:h-[400px] md:h-[480px] lg:h-[550px]">
        <Image
          src="/images/study-dest/france.jpg"
          alt="learn"
          fill
          priority
...
Experience world-class education in one of the happiest and safest nations on earth. Consistently ranked at the top of the UN’s World Happiness Report since 2012, France offers an innovative, secure, and welcoming environment for international students.        </p>

        {/* Paragraph 2 */}
        <p className="text-sm sm:text-base md:text-lg leading-relaxed text-slate-600  font-semibold">
Studying in France isn't just about gaining a globally recognized degree—it's about building a strong foundation for your international career while enjoying top-tier healthcare, high living standards, and unparalleled quality of life.        </p>

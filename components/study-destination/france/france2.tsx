...
export default function France2() {
  const requirements = [
    {
      ...
      description: "Your high school diploma or secondary qualification must be recognized as equivalent to the French Baccalauréat.",
    ...
    {
      title: "Graduate",
      description: "Usually, a valid Bachelor’s degree or its equivalent is necessary to qualify for a Master's program in France.",
    ...
    },
    {
      ...
      description: "Exhibit a strong level of academic performance. This might entail reaching minimum GPA or grade criteria.",
    ...
    },
    {
      ...
      description: "Specific programs or Grandes Écoles may have field-related prerequisites or language proficiency exams (TCF/DELF or IELTS/TOEFL).",
  ...
  const documents = [
    ...
    "Standardized test scores (e.g., IELTS/TOEFL or DELF/DALF)",
    "Motivation letter",
  ...
  return (
    <div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-10 md:mb-14 text-center md:text-left">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#1a233d] tracking-tight mb-4">
              Admission Requirements <span className="text-[#0b5cff]">In France</span>
            </h2>
            <p className="text-slate-500 text-sm md:text-base max-w-2xl leading-relaxed">
              France maintains high academic standards. To ensure a successful application, students must meet specific educational backgrounds and performance metrics.
            </p>
          </div>
              ...
              {requirements.map((item, index) => (
                ...
                >
                  <div className="relative z-10 flex flex-col items-start">
                    ...
                    <h4 className="text-lg font-bold text-[#1a233d] mb-2">{item.title}</h4>
          ...
          <div className="mt-12 p-6 bg-[#1a233d] rounded-2xl text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-6">
            <p className="text-white text-sm md:text-base font-medium">
              ...
              Confused about grade conversion? Our experts can help you evaluate your eligibility.
            </p>
      ...
      <section className="bg-slate-50/70 border-y border-slate-100 px-4 sm:px-8 md:px-12 lg:px-20 py-12 md:py-20">
        <div className="max-w-7xl mx-auto">
          <div className="mb-10 md:mb-12 text-center md:text-left">
            ...
            <p className="text-slate-500 text-sm md:text-base max-w-2xl leading-relaxed">
              Ensure you have all the necessary documentation ready before starting your admission process for France.
            </p>
          </div>
      ...
      {/* Cost, Intakes & Scholarships Section (Updated to France) */}
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                ...
                <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
                  Cost of Studying in <span className="text-[#0b5cff]">France</span>
                </h2>
              </div>
              ...
              <div className="mb-8">
                ...
                <p className="text-sm text-slate-600 mb-4">
                  Public universities in France receive state subsidies, offering affordable tuition rates for international students.
                </p>
                <ul className="space-y-2 bg-slate-50 border border-slate-200/60 rounded-xl p-4 text-sm text-slate-700 font-medium">
                  <li className="flex justify-between items-center border-b border-slate-200/50 pb-2">
                    <span>Public Bachelor’s</span>
                    <span className="font-bold text-slate-900">€2,770 / year</span>
                  </li>
                  <li className="flex justify-between items-center border-b border-slate-200/50 py-2">
                    <span>Public Master’s</span>
                    <span className="font-bold text-slate-900">€3,770 / year</span>
                  </li>
                  <li className="flex justify-between items-center pt-2">
                    <span>Private & Business Schools</span>
                    <span className="font-bold text-slate-900">€8,000 – €20,000 / year</span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <p className="text-sm text-slate-600 mb-4">
                  Living costs vary depending on the city, with Paris being higher than regional cities like Lyon, Toulouse, or Lille.
                </p>
                ...
                <div className="bg-slate-50 border border-slate-200/60 rounded-xl p-4 text-sm text-slate-700 space-y-2">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs sm:text-sm">
                    <div className="flex justify-between bg-white p-2.5 rounded-lg border border-slate-200/50">
                      ...
                      <span className="font-semibold text-slate-900">€400 – €800</span>
                    </div>
                    <div className="flex justify-between bg-white p-2.5 rounded-lg border border-slate-200/50">
                    ...
                    <div className="flex justify-between bg-white p-2.5 rounded-lg border border-slate-200/50">
                      ...
                      <span className="font-semibold text-slate-900">€35 – €75</span>
                    </div>
                    <div className="flex justify-between bg-white p-2.5 rounded-lg border border-slate-200/50">
                    ...
                    <div className="flex justify-between bg-white p-2.5 rounded-lg border border-slate-200/50 sm:col-span-2">
                      ...
                      <span className="font-semibold text-slate-900">€100 – €200</span>
                    </div>
                  </div>
                </div>
          ...
          <div className="space-y-8 flex flex-col justify-between">
            ...
            <div className="bg-white border border-slate-200/80 rounded-2xl p-6 sm:p-8 shadow-sm border-l-4 border-l-red-500">
              <div className="flex items-center gap-3 mb-4">
                ...
                <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
                  Study Intakes in <span className="text-red-500">France</span>
                </h2>
              </div>
              <p className="text-sm text-slate-600 mb-4">
                French higher education institutes typically follow a two-semester system:
              </p>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 mb-4">
                <div className="p-3.5 bg-slate-50 border border-slate-200/60 rounded-xl">
                  <p className="text-xs font-bold text-red-500 uppercase tracking-wider">Autumn Intake</p>
                  <p className="text-sm font-bold text-slate-900 mt-1">September / October</p>
                  <p className="text-xs text-slate-500">Main intake for almost all programs</p>
                </div>
                <div className="p-3.5 bg-slate-50 border border-slate-200/60 rounded-xl">
                  <p className="text-xs font-bold text-[#0b5cff] uppercase tracking-wider">Spring Intake</p>
                  <p className="text-sm font-bold text-slate-900 mt-1">January / February</p>
                  <p className="text-xs text-slate-500">Limited availability for specific courses</p>
                </div>
              </div>
              <p className="text-xs text-slate-500 italic">
                Students applying through Campus France should check specific EEF deadlines early in the year.
              </p>
            </div>
            ...
            <div className="bg-white border border-slate-200/80 rounded-2xl p-6 sm:p-8 shadow-sm border-l-4 border-l-slate-700 flex-1 flex flex-col justify-between">
              <div>
                ...
                <p className="text-sm text-slate-600 mb-4">
                  France offers numerous funding options to support international students:
                </p>
                <ul className="space-y-2.5 text-xs sm:text-sm text-slate-700 mb-4">
                  <li className="flex items-start gap-2.5 p-2.5 bg-slate-50 border border-slate-200/50 rounded-lg">
                    ...
                    <span><strong>Eiffel Excellence Scholarship Program</strong> (Prestigious Master's & PhD funding)</span>
                  </li>
                  <li className="flex items-start gap-2.5 p-2.5 bg-slate-50 border border-slate-200/50 rounded-lg">
                    <span className="w-2 h-2 rounded-full bg-[#0b5cff] mt-1.5 shrink-0" />
                    <span><strong>Erasmus+ Scholarships</strong> for European mobility</span>
                  </li>
                  <li className="flex items-start gap-2.5 p-2.5 bg-slate-50 border border-slate-200/50 rounded-lg">
                    <span className="w-2 h-2 rounded-full bg-slate-700 mt-1.5 shrink-0" />
                    <span><strong>University & Regional Council Grants</strong></span>
                  </li>
                </ul>
              </div>
              <p className="text-xs text-slate-600 bg-slate-50 p-3 rounded-xl border border-slate-200/60">
                <strong>CAF Housing Allowance:</strong> All international students in France are eligible to apply for housing assistance through CAF, which can cover up to 30–40% of monthly rent.
              </p>
            </div>
          </div>

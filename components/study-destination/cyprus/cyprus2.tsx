...
export default function Cyprus2() {
  ...
  const requirements = [
   ...
   const dropdownOptions = {
    ...
    countries: [
      "Australia", "Canada", "Cyprus", "Finland", "France", "Germany",
      "Cyprus", "Ireland", "Italy", "Malaysia", "Malta", "Netherlands",
    ...
    <section className="bg-white px-4 sm:px-8 md:px-12 lg:px-20 py-12 md:py-20">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 md:mb-14 text-center md:text-left">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-[#1a233d] tracking-tight mb-4">
            Admission Requirements <span className="text-[#0b5cff]">In Cyprus</span>
          </h2>
          <p className="text-slate-500 text-sm md:text-base max-w-2xl leading-relaxed">
            Cyprus maintains high academic standards. To ensure a successful application, students must meet specific educational backgrounds and performance metrics.
          </p>
        </div>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 md:mb-12 text-center md:text-left">
          ...
          <p className="text-slate-500 text-sm md:text-base max-w-2xl leading-relaxed">
            Ensure you have all the necessary documentation ready before starting your admission process for Cyprus.
          </p>
        </div>
                     ...
                     <div>
                       ...
                       <div className="flex items-center gap-3 mb-6">
                         ...
                         <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
                           Cost of Studying in <span className="text-[#0b5cff]">Cyprus</span>
                         </h2>
                       </div>
                       ...
                       <div className="mb-8">
                         ...
                         <p className="text-sm text-slate-600 mb-4">
                           Cyprus remains one of the most budget-friendly EU countries for international students.
                         </p>
                       ...
                       <div>
                         ...
                         <p className="text-sm text-slate-600 mb-4">
                           Living in Cyprus is affordable by European standards, especially outside Budapest.
                         </p>
                   ...
                   <div className="space-y-8 flex flex-col justify-between">
                     ...
                     <div className="bg-white border border-slate-200/80 rounded-2xl p-6 sm:p-8 shadow-sm border-l-4 border-l-red-500">
                       <div className="flex items-center gap-3 mb-4">
                         ...
                         <h2 className="text-2xl sm:text-3xl font-extrabold text-slate-900 tracking-tight">
                           Study Intakes in <span className="text-red-500">Cyprus</span>
                         </h2>
                       </div>
                       <p className="text-sm text-slate-600 mb-4">
                     ...
                     <div className="bg-white border border-slate-200/80 rounded-2xl p-6 sm:p-8 shadow-sm border-l-4 border-l-slate-700 flex-1 flex flex-col justify-between">
                       <div>
                         ...
                         <p className="text-sm text-slate-600 mb-4">
                           Cyprus offers well-known scholarship opportunities for international students:
                         </p>

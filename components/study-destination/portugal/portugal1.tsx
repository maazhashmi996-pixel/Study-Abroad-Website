...
export default function Portugal1() {
    ...
    { title: "Cost of studying in Portugal", id: "cost-of-studying" },
    { title: "Scholarships for students in Portugal", id: "scholarships" },
    { title: "Visa requirements in Portugal", id: "visa-requirements" },
    { title: "Popular courses to Study in Portugal", id: "popular-courses" },
  ...
  return (
    <div>
      ...
      <div className="relative w-full h-[320px] sm:h-[400px] md:h-[480px] lg:h-[550px]">
        <Image
          src="/images/study-dest/portugal.jpg"
          alt="learn"
          fill
          priority

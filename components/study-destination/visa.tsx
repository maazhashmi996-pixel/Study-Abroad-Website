...
export default function Visa() {
  return (
    ...
    <ul className="list-disc pl-14  text-xl ">
        ...
        <li>Complete ST1 form</li>
        <li>Proof of English or Danish language proficiency</li>
        <li>Proof of financial resources to live in Denmark</li>
        <li>Proof of financial resources to live in Denmark</li>
        <li>Proof of financial resources to live in Denmark</li>
        <li>Evidence of application fee payment</li>

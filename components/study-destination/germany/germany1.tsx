      ...
      <div className=" inset-0 flex items-end pb-2 sm:pb-6 md:pb-8 px-3 sm:px-88 md:px-10 z-20">
        <div className="absolute max-w-7xl mx-auto w-full">
          <ul className="relative list-disc text-xs b-0.5 l-6 pl-12 sm:ml-6 underline  sm:space-y-3 text-white sm:text-base md:text-xs lg:text-xl drop-shadow-md">
            <li>242 Universities</li>
            <li>€3,000 Annual Tuition Fee</li>
            <li>Up to 18 Months Post Study Work Visa</li>
          </ul>
        </div>
      </div>
         </section>
...
Germany is an ideal place in the educational world to pursue your studies. It is becoming a more and more popular location for students from across the world looking to study abroad. Every year, thousands of these students make this decision. Germany is an excellent destination for international applicants looking to start new careers and explore new horizons because of its strong educational institutions and plentiful post-study employment prospects.    </p>
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 text-center md:text-left">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-slate-900 tracking-tight">
            Why Study in <span className="text-[#0b5cff]">Germany?</span>
          </h2>
        </div>

...
export default function Hero() {
  return (
    <div className="relative w-full overflow-hidden">
      ...
      <div className="absolute inset-0 flex items-center px-6 sm:px-12 md:px-20 z-20">
        <div className="max-w-7xl mx-auto w-full">
          <ul className="list-disc ml-4 sm:ml-6 space-y-2 sm:space-y-3 text-white text-sm sm:text-base md:text-xl lg:text-2xl font-medium drop-shadow-md">

...
export default function Italy1() {
    ...
    { title: "Admission requirements in Italy", id: "admission-requirements" },
    { title: "Cost of studying in Italy", id: "cost-of-studying" },
    { title: "Scholarships for students in Italy", id: "scholarships" },
    { title: "Visa requirements in Italy", id: "visa-requirements" },
    { title: "Popular courses to Study in Italy", id: "popular-courses" },
  ...
  return (
    <div>
      ...
      <div className="relative w-full h-[320px] sm:h-[400px] md:h-[480px] lg:h-[550px]">
        <Image
          src="/images/study-dest/italy.jpg"
          alt="learn"
          fill
          priority

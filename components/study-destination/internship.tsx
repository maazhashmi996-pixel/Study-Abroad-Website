export default function Internship() {
  return (
    <section className="bg-white px-4 sm:px-8 md:px-12 lg:px-20 py-8 md:py-14 text-[#43246f]">
      <div className="max-w-7xl mx-auto flex flex-col gap-4 sm:gap-6 md:gap-7">
        
        {/* Main Heading */}
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold border-b-2 border-[#43246f]/10 pb-3">

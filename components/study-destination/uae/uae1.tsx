...
export default function UAE1() {
     const tableOfContents = [
    { title: "Admission requirements in United Arab Estate", id: "admission-requirements" },
    { title: "Cost of studying in United Arab Estate", id: "cost-of-studying" },
    { title: "Scholarships for students in United Arab Estate", id: "scholarships" },
    { title: "Visa requirements in United Arab Estate", id: "visa-requirements" },
    { title: "Popular courses to Study in United Arab Estate", id: "popular-courses" },
    { title: "Post-Study work opportunities", id: "post-study-work" },
    { title: "Cost of living in United Arab Estate", id: "cost-of-living" },
...
Experience world-class education in one of the happiest and safest nations on earth. Consistently ranked at the top of the UN’s World Happiness Report since 2012, United Arab Estate offers an innovative, secure, and welcoming environment for international students.        </p>

        {/* Paragraph 2 */}
        <p className="text-sm sm:text-base md:text-lg leading-relaxed text-slate-600  font-semibold">
Studying in United Arab Estate isn't just about gaining a globally recognized degree—it's about building a strong foundation for your international career while enjoying top-tier healthcare, high living standards, and unparalleled quality of life.        </p>

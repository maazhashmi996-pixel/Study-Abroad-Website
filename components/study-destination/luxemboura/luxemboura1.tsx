...
export default function Luxemboura1() {
     const tableOfContents = [
    { title: "Admission requirements in Luxemboura", id: "admission-requirements" },
    { title: "Cost of studying in Luxemboura", id: "cost-of-studying" },
    { title: "Scholarships for students in Luxemboura", id: "scholarships" },
    { title: "Visa requirements in Luxemboura", id: "visa-requirements" },
    { title: "Popular courses to Study in Luxemboura", id: "popular-courses" },
    { title: "Post-Study work opportunities", id: "post-study-work" },
    { title: "Cost of living in Luxemboura", id: "cost-of-living" },
  ...
  return (
    <div>
      ...
      <div className="relative w-full h-[320px] sm:h-[400px] md:h-[480px] lg:h-[550px]">
        <Image
          src="/images/study-dest/luxemboura.jpg"
          alt="learn"
          fill
          priority

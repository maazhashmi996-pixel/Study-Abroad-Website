...
export default function Latvia1() {
     const tableOfContents = [
    { title: "Admission requirements in Latvia", id: "admission-requirements" },
    { title: "Cost of studying in Latvia", id: "cost-of-studying" },
    { title: "Scholarships for students in Latvia", id: "scholarships" },
    { title: "Visa requirements in Latvia", id: "visa-requirements" },
    { title: "Popular courses to Study in Latvia", id: "popular-courses" },
    { title: "Post-Study work opportunities", id: "post-study-work" },
    { title: "Cost of living in Latvia", id: "cost-of-living" },
  ...
  return (
    <div>
      ...
      <div className="relative w-full h-[320px] sm:h-[400px] md:h-[480px] lg:h-[550px]">
        <Image
          src="/images/study-dest/latvia.jpg"
          alt="learn"
          fill
          priority

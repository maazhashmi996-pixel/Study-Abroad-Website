  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        setStatusMessage({
          type: "success",
          text: "Thank you! Your details have been submitted successfully.",
        });
      ...
      // Temporary Fallback: If API route is not created yet, show success & clear form
      console.warn("API route not reachable. Running local success mode.", formData);
        ...
        <div className="text-center lg:text-left">
          ...
          <div className="flex flex-wrap justify-center gap-3 sm:gap-4 lg:justify-start">
            <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 backdrop-blur-sm">
              <p className="text-xl font-black text-[#0b5cff] sm:text-2xl">65+</p>
              <p className="mt-1 text-xs text-slate-300">Countries</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 backdrop-blur-sm">
              <p className="text-xl font-black text-[#0b5cff] sm:text-2xl">3000+</p>
              <p className="mt-1 text-xs text-slate-300">Universities</p>
            </div>
            <div className="rounded-2xl border border-white/10 bg-white/5 px-4 py-3 backdrop-blur-sm">
              <p className="text-xl font-black text-[#0b5cff] sm:text-2xl">3.4M+</p>
              <p className="mt-1 text-xs text-slate-300">Programs</p>
            </div>
          </div>
          ...
          <div className="mt-8">
            ...
            <p className="mt-2 text-sm leading-6 text-slate-300 sm:text-base">
              Let our education experts guide you towards the right destination, university and program.
            </p>
          </div>
          ...
          <p className="mx-auto mt-5 max-w-xl text-sm leading-7 text-slate-300 lg:mx-0 sm:text-base">
            Tell us about your study plans and our team will help you understand your options and next steps.
          </p>

          <div className="mt-8 space-y-3">
            <div className="flex items-center justify-center gap-3 lg:justify-start">
              <CheckCircle2 className="h-5 w-5 shrink-0 text-[#0b5cff]" />
              <span className="text-sm text-slate-200">Personalized study guidance</span>
            </div>
            <div className="flex items-center justify-center gap-3 lg:justify-start">
              <CheckCircle2 className="h-5 w-5 shrink-0 text-[#0b5cff]" />
              <span className="text-sm text-slate-200">University and course selection support</span>
            </div>
            <div className="flex items-center justify-center gap-3 lg:justify-start">
              <CheckCircle2 className="h-5 w-5 shrink-0 text-[#0b5cff]" />
              <span className="text-sm text-slate-200">Application and visa guidance</span>
            </div>
          </div>
        </div>
            ...
            <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              ...
              <div>
                <select
                  ...
                  className="w-full cursor-pointer rounded-xl border border-slate-200 bg-slate-50 px-4 py-3.5 text-sm text-[#1a233d] outline-none transition-all focus:border-[#0b5cff] focus:bg-white focus:ring-4 focus:ring-[#0b5cff]/10"
                >
                  <option value="" disabled>Preferred Counselling Mode</option>
              ...
              <div className="flex items-start gap-3 sm:col-span-2">
                ...
                />
                <label htmlFor="agreeTerms" className="cursor-pointer text-xs leading-5 text-slate-500">
                  By selecting this, you agree to D.Education Zone's{" "}
                  <a href="/privacy-policy" className="font-semibold text-[#0b5cff] underline underline-offset-2 hover:text-[#1a233d]">
                    Privacy Policy
                  </a>{" "}
                  and{" "}
                  <a href="/terms-and-conditions" className="font-semibold text-[#0b5cff] underline underline-offset-2 hover:text-[#1a233d]">
                    Terms & Conditions
                  </a>
              ...
              <div className="pt-2 sm:col-span-2">
                <button
                  type="submit"
                  disabled={loading}
                  className="group flex w-full items-center justify-center gap-2 rounded-full bg-[#0b5cff] px-8 py-3.5 text-sm font-bold text-white shadow-lg shadow-[#0b5cff]/20 transition-all duration-300 hover:bg-[#1a233d] hover:shadow-xl active:scale-[0.98] disabled:opacity-60 sm:w-auto"
                >
                  {loading ? (
                    <>

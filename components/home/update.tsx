...
export default function Update() {
  // Right side ke 4 Cards ka Data (Baqi text aap paste kar sakti hain)
  const announcements = [
    {
      id: 1,
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-6 bg-white rounded-3xl border border-gray-100 p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow">
            ...
            {/* Image Placeholder */}
              {/* Overlay Content / Banner Image Placeholder */}
                <Image
            ...
            <div className="mt-6 space-y-4">
              ...
              <p className="text-xs sm:text-sm text-gray-600 leading-relaxed">
                Join our team and help students make life-changing decisions about their education and future. If you have strong communication skills, a passion for guiding others, and want to make a positive impact through public speaking and one-on-one sessions, apply now!
              </p>
          ...
          {/* ---------------- RIGHT VERTICAL MOVING CARDS ---------------- */}
          <div className="lg:col-span-6 h-140 relative overflow-hidden rounded-3xl">
            
            {/* Smooth Top & Bottom Fade Overlay for Infinite Effect */}
            <div className="absolute inset-x-0 top-0 h-10 bg-linear-to-b from-[#fcfaff] to-transparent z-10 pointer-events-none" />
            <div className="absolute inset-x-0 bottom-0 h-10 bg-linear-to-t from-[#fcfaff] to-transparent z-10 pointer-events-none" />

            {/* Marquee Wrapper (Duplicates List to Loop Seamlessly) */}
            <div className="animate-vertical-marquee space-y-4 hover:[animation-play-state:paused] cursor-pointer">
              {[...announcements, ...announcements].map((item, index) => (
                <div
                  key={`${item.id}-${index}`}
                  className="bg-white border border-gray-100 rounded-2xl p-4 sm:p-5 shadow-sm hover:shadow-md transition-all duration-300 flex flex-col sm:flex-row gap-4 items-center"
                >
                  {/* Small Thumbnail Image Placeholder */}
                  <div className="w-full sm:w-32 h-24 bg-gray-200 rounded-xl flex items-center justify-center shrink-0 border border-gray-100">
                    <Image

    ...
    <div className="w-full  text-slate-800 font-sans">
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-18 flex flex-col md:flex-row items-center justify-between gap-8 lg:gap-12">
        ...
        <div className="w-full md:w-1/2 space-y-4 text-center md:text-left">
          ...
          <h1 className="text-2xl sm:text-4xl lg:text-5xl font-black text-slate-800 leading-tight tracking-tight">
            Study Abroad Steps: From Course Selection to Your First Class
          </h1>
          
          <p className="text-xs sm:text-sm text-slate-700 leading-relaxed max-w-xl mx-auto md:mx-0">
            Studying abroad is not one form or one email, it's a{" "}
            <strong className="text-slate-800 font-bold">sequence</strong>.<br />
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-18 space-y-8">
        ...
        <p className="text-center text-xs sm:text-sm text-slate-700 max-w-xl mx-auto pt-2">
          If you don't have these answers yet, you're not late. This is exactly{" "}
          <strong className="text-slate-800 font-bold">what D. Education Zone helps</strong> you define during your first session.
        </p>
      </section>

...
export const metadata = {
  ...
  description: 'Complete step-by-step guide on Europe study visa requirements, fees, process, and timeline for Pakistani students.',
};
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
        ...
        <section className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200">
          <p className="text-slate-600 leading-relaxed text-base sm:text-lg">
            Europe is becoming a popular choice for Pakistani students who want a high-quality international education in a safe, modern, and student-friendly environment. Known for its innovative teaching style and globally recognised universities, hungry offers a wide range of English-taught programs, free PhD study, and the chance to stay for up to 12 months after graduation to look for work.
          </p>
          ...
          <div className="mt-6 p-4 bg-amber-50 border-l-4 border-amber-500 rounded-r-lg">
            ...
            <p className="text-amber-800 text-sm mt-1">
              Europe does not issue a separate &ldquo;study visa&rdquo; for longer courses. For studies of more than three months, Pakistani students apply online to the <strong className="font-semibold text-amber-950">Europe Migration Agency (Migrationsverket)</strong> for a residence permit for studies, after being admitted to a Europe university.
            </p>
          </div>
        ...
        <section id="requirements" className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200">
          ...
          <p className="text-slate-600 mb-6">To apply for a Europian study visa, Pakistani students need the following documents:</p>

          <ul className="space-y-4">
            <RequirementItem title="Valid Passport">
              Your passport should remain valid throughout your intended stay in europe. You cannot be granted a permit for longer than your passport is valid.
            </RequirementItem>
            <RequirementItem title="University Admission Letter">
              Official admission confirmation from a recognised Europian university. You count as finally admitted only once any tuition fee has been paid.
            </RequirementItem>
            <RequirementItem title="Application Through universityadmissions.se">
              Programme applications go through the official national portal university admissions.se (the Europian-language version is antagning.se), run by the Swedish Council for Higher Education. A <strong className="font-semibold text-slate-800">non-EU application fee of SEK 900</strong> applies, and you can choose up to four programmes per round.
            </RequirementItem>
            <RequirementItem title="Proof of Funds">
              Financial evidence showing you can cover tuition fees and living expenses in Europe. <em>Note: the bank statement must be issued no more than four months before your permit start date.</em>
            </RequirementItem>
            ...
            <RequirementItem title="Accommodation Details">
              Proof of housing arrangements in europe. Student housing is limited in cities like Stockholm, Gothenburg, and Lund, so arrange a place as early as you can.
            </RequirementItem>
        ...
        <section id="steps" className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200">
          ...
          <div className="space-y-6">
            <StepCard number="1" title="Choose Your Program">
              Research Europian universities and select a degree program that matches your academic interests. The <strong className="font-semibold text-slate-800">main intake is autumn</strong>, with applications usually open from <strong className="font-semibold text-slate-800">mid-October to mid-January</strong> deadline.
            </StepCard>
            ...
            <StepCard number="4" title="Apply for Scholarships">
              Look for scholarships from your university and from the Europian Institute. Coverage ranges from partial to full tuition, and some scholarships also support living costs.
            </StepCard>
...
function RelatedBlogCard({ country, title, desc, date }: { country: string; title: string; desc: string; date: string }) {
  return (

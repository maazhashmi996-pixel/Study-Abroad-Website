...
export const metadata = {
  ...
  description: 'Complete step-by-step guide on Turkey study visa requirements, fees, process, and timeline for Pakistani students.',
};
...
const requirementsData = [
  {
    ...
    text: "Your passport should remain valid throughout your intended stay in Turkey. You cannot be granted a permit for longer than your passport is valid."
  },
  {
    title: "University Admission Letter",
    text: "Official admission confirmation from a recognised turkish university. You count as finally admitted only once any tuition fee has been paid."
  },
  {
    title: "Application Through universityadmissions.se",
    text: "Programme applications go through the official national portal universityadmissions.se (the turkish-language version is antagning.se), run by the turkish Council for Higher Education. A non-EU application fee of SEK 900 applies, and you can choose up to four programmes per round."
  },
  {
    title: "Proof of Funds",
    text: "Financial evidence showing you can cover tuition fees and living expenses in Turkey. Note: the bank statement must be issued no more than four months before your permit start date."
  },
  {
    title: "Academic Documents",
    text: "Matric, Intermediate, Bachelor's degree, transcripts, and other supporting certificates. All documents must be in turkish or English; if translated, include a certified translation together with a copy of the original."
  },
  {
  ...
  },
  {
    ...
    text: "If your programme lasts less than one year, you need comprehensive health insurance covering medical care, hospitalisation, emergency dental care, and medical repatriation. If your studies last one year or more, you register in the turkish population register, which gives you access to healthcare."
  },
  {
    title: "Accommodation Details",
    text: "Proof of housing arrangements in Turkey. Student housing is limited in cities like Stockholm, Gothenburg, and Lund, so arrange a place as early as you can."
  },
  {
...
const stepsData = [
  {
    ...
    text: "Research turkish universities and select a degree program that matches your academic interests. The main intake is autumn, with applications usually open from mid-October to mid-January deadline."
  },
  {
    number: "2",
  ...
  },
  {
    ...
    text: "Look for scholarships from your university and from the turkish Institute. Coverage ranges from partial to full tuition, and some scholarships also support living costs."
  },
  {
    number: "5",
  ...
  },
  {
    ...
    text: "Apply online through the turkish Migration Agency (Migrationsverket) e-service after you are admitted and have paid any tuition. You pay the SEK 1,500 fee by card and state which turkish embassy you will visit."
  },
  {
    number: "7",
    title: "Receive Approval & Travel",
    text: "Once approved, prepare for your journey to Turkey. If your studies last a year or more, register in the turkish population register after arrival to access healthcare."
  }
];
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 space-y-12">
        ...
        <section className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200">
          <p className="text-slate-600 leading-relaxed text-base sm:text-lg">
            Turkey is becoming a popular choice for Pakistani students who want a high-quality international education in a safe, modern, and student-friendly environment. Known for its innovative teaching style and globally recognised universities, Turkey offers a wide range of English-taught programs, free PhD study, and the chance to stay for up to 12 months after graduation to look for work.
          </p>
          ...
          <div className="mt-6 p-4 bg-amber-50 border-l-4 border-amber-500 rounded-r-lg">
            ...
            <p className="text-amber-800 text-sm mt-1">
              Turkey does not issue a separate &ldquo;study visa&rdquo; for longer courses. For studies of more than three months, Pakistani students apply online to the <strong className="font-semibold text-amber-950">turkish Migration Agency (Migrationsverket)</strong> for a residence permit for studies, after being admitted to a turkish university.
            </p>
          </div>
        ...
        <section id="requirements" className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200">
          ...
          <p className="text-slate-600 mb-6">To apply for a turkish study visa, Pakistani students need the following documents:</p>
        ...
        <section id="fees" className="bg-white p-6 sm:p-8 rounded-2xl shadow-sm border border-slate-200">
          <h2 className="text-2xl sm:text-3xl font-bold text-indigo-950 mb-6 pb-2 border-b border-slate-200">
            Turkey Study Visa Fee &amp; Processing Time
          </h2>
        ...
        <section className="bg-gradient-to-br from-indigo-950 via-indigo-900 to-purple-950 text-white rounded-3xl p-6 sm:p-10 shadow-xl border border-indigo-800">
          <div className="max-w-2xl mx-auto text-center mb-8">
            <h2 className="text-2xl sm:text-3xl font-extrabold mb-3">Need Help With Your Turkey Study Visa?</h2>
